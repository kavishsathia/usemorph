...
const Nav: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 w-full z-40 px-6 py-6 flex justify-between items-center mix-blend-difference text-morph-white">
      ...
      >
        <a href="#philosophy" className="hover:text-morph-blue transition-colors duration-300">Manifesto</a>
        <a href="#modules" className="hover:text-morph-blue transition-colors duration-300">Modules</a>
        <span className="opacity-30">/</span>
        <a href="#access" className="hover:text-morph-blue transition-colors duration-300">Access</a>
      </motion.div>
    </nav>
  );
};
